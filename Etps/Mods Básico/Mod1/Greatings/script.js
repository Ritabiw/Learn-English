    ...
    if (nextBtn && step1 && step2) {
        nextBtn.addEventListener('click', () => {
            ...
            if (!step1.classList.contains('hidden')) {
                ...
                // if (container) container.classList.add('transparent'); // Comentado para manter o container visível
                // document.body.classList.add('white-bg'); // Comentado para manter o fundo padrão
    ...
    if (prevBtn && step1 && step2) {
        prevBtn.addEventListener('click', () => {
            ...
            if (!step2.classList.contains('hidden')) {
                ...
                // if (container) container.classList.remove('transparent'); // Comentado pois a classe não é mais adicionada
                // document.body.classList.remove('white-bg'); // Comentado pois a classe não é mais adicionada
            }
        });
    }
